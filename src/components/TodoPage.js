      ...
      <div className="todocontainer">
        ...
        <div className="todomain">
          <div className="tododonebuttons">
            <button
              className={this.state.todo ? "buttonstyle" : "buttonstyle hidden"}
              onClick={this.todoButton}
            >
              To Do
            </button>
            <button
              className={this.state.todo ? "buttonstyle hidden" : "buttonstyle"}
          ...
          {todo ? (
            ...
            <h1 className="todoTitle">Tasks to do</h1>
          )}
          <TaskInput
            sendTime={sendTime}
            todo={todo}
